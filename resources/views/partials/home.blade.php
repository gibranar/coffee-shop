<article class="h-[calc(100vh-20.5vh)] grid grid-cols-1 md:grid-cols-2 xl:px-32 2xl:px-40">
    ...
    <section class="flex flex-col items-center justify-center gap-4 border-2 rounded-tr-lg rounded-br-lg">
        ...
        <h1 class="uppercase text-4xl font-extrabold tracking-widest">Special <span class="text-primary">Coffee</span>
        </h1>
        <p class="w-4/6 text-center text-gray-500 font-faberSansStd">Lorem ipsum, dolor sit amet consectetur adipisicing
            ...
            dolore pariatur.</p>
        <button
            class="border border-gray-500 py-2 px-5 font-bold font-sans rounded-full hover:bg-primary transition-all">Order
            Now</button>
    </section>
